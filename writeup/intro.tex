...
\begin{document} 
    ...
    For the Users table, the only functional dependency is user\_id $\rightarrow$ first\_name, last\_name, email, subscription\_id.
    This functional dependency exists because user\_id is a key for Users.
